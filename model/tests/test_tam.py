...
def test_to_dict():
  ...
  expected = [
      ...
      'forecast_data_pds_global', 'forecast_min_max_sd_pds_global',
      'forecast_low_med_high_pds_global',
      'forecast_trend_linear_pds_global', 'forecast_trend_degree2_pds_global',
      'forecast_trend_degree3_pds_global', 'forecast_trend_exponential_pds_global',
