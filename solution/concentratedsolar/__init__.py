"""Concentrated Solar Power (CSP) solution model.
   Excel filename: CSP_RRS_ELECGEN_v1.1b_18Jan2020.xlsm
"""
...
VMAs = {
    ...
    'Learning rate': vma.VMA(
        ...
        use_weight=False),
    'Annual CO2 savings from STE': vma.VMA(
...
PDS1 = "PDS-4p2050-Plausible (Book Ed. 1)"
PDS2 = "PDS-8p2050-Drawdown (Book Ed.1)"
PDS3 = "PDS-8p2050-Optimum (Book Ed.1)"
    ...
    def __init__(self, scen=None):
        ...
        ad_data_sources = {
            'Baseline Cases': {
                ...
                'Based on IEA, RE-2018, Main Case': THISDIR.joinpath('ad', 'ad_based_on_IEA_RE2018_Main_Case.csv'),
