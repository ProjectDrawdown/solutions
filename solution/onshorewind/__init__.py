...
scenarios = {
  'PDS-22p2050-Plausible (Book Ed. 1)': advanced_controls.AdvancedControls(
      ...
      pds_base_adoption=[('World', 689.0), ('OECD90', 443.891), ('Eastern Europe', 1.901), ('Asia (Sans Japan)', 194.66), ('Middle East and Africa', 5.326), ('Latin America', 18.675), ('China', 157.379), ('India', 33.455), ('EU', 230.075), ('USA', 183.892)], 
