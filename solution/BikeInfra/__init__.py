    ...
    def __init__(self, scenario=None):
        ...
        ca_pds_data_sources = [
            {'name': '(PDS2) Drawdown Team projections based on a weighted average of Several Sources',
              'include': True,
              'description': (
                    'Taking Published projections for each of Project Drawdowns five regions, we '
                    'estimate the regional growth in bike infrastructure usage and then sum each '
                    'year after interpolations. These sources exclude the ITDP data which are '
                    'used for the Plausible (PDS1) Scenario '
                    ),
        ...
        # Custom REF Data
        ca_ref_data_sources = [
            {'name': 'Drawdown Book Ed.1 Reference Scenario',
              'include': True,
              'description': (
            ...
            {'name': 'Linear REF Growth Integrated with Recent Historical Adoption',
              'include': True,
              'description': (
