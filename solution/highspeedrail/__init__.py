"""High Speed Rail solution model.
   Excel filename: HighSpeedRail-RRSv1.1b-10Oct19.xlsm
"""
...
VMAs = {
    ...
    'N2O-CO2eq Tons Reduced': vma.VMA(
        filename=None, use_weight=False),
    'Discount Rate - Governments': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "Discount_Rate_Governments.csv"),
        use_weight=True),
    'Airport Operating Costs': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "Airport_Operating_Costs.csv"),
        use_weight=False),
    'Airline Operating Costs': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "Airline_Operating_Costs.csv"),
        use_weight=False),
    'HSR Rolling Stock Running Costs- Europe': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "HSR_Rolling_Stock_Running_Costs_Europe.csv"),
        use_weight=False),
    'HSR Infrastructure Cost - Europe': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "HSR_Infrastructure_Cost_Europe.csv"),
        use_weight=False),
...
PDS1 = "PDS1-4p2050-Announced Constr+1%Traffic Density (Book Ed.1)"
PDS2 = "PDS2-4p2050-Announced Constr+2.5% Traffic Density Inc (Book Ed.1)"
PDS3 = "PDS3-5p2050-Japanese Travel Density (Book Ed.1)"
