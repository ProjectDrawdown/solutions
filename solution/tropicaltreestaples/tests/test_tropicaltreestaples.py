...
solution_name = 'tropicaltreestaples'
...
def test_tropicaltreestaples_loader():
...
@pytest.mark.slow
def test_tropicaltreestaples_results(scenario_skip=None, test_skip=None, test_only=None):
