...
solution_name = 'peatlandrestoration'
...
def test_peatlandrestoration_loader():
...
@pytest.mark.slow
def test_peatlandrestoration_results(scenario_skip=None, test_skip=None, test_only=None):
