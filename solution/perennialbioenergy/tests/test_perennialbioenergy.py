...
solution_name = 'perennialbioenergy'
...
def test_perennialbioenergy_loader():
...
@pytest.mark.slow
def test_perennialbioenergy_results(scenario_skip=None, test_skip=None, test_only=None):
