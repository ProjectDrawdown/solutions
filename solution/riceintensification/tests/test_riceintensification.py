...
solution_name = 'riceintensification'
...
def test_riceintensification_loader():
...
@pytest.mark.slow
def test_riceintensification_results(scenario_skip=None, test_skip=None, test_only=None):
