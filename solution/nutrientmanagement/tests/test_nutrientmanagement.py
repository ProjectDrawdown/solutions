...
solution_name = 'nutrientmanagement'
...
def test_nutrientmanagement_loader():
...
@pytest.mark.slow
def test_nutrientmanagement_results(scenario_skip=None, test_skip=None, test_only=None):
