...
from clusters import water_heating

test_cluster = water_heating.Cluster()
test_dfs = test_cluster.run_cluster()

expected_df = pd.read_csv('expected_water_heating.csv', header=None)
...
def test_water_heating():
    ...
    print("Test complete: water heating cluster")
