...
from clusters import com_light

test_cluster = com_light.Cluster()
test_dfs = test_cluster.run_cluster()

expected_df = pd.read_csv('expected_com_light.csv', header=None)
...
def test_com_light():
    ...
    print("Test complete: com light cluster")
