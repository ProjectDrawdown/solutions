...
from clusters import space_cooling

test_cluster = space_cooling.Cluster()
test_dfs = test_cluster.run_cluster()

expected_df = pd.read_csv('expected_space_cooling.csv', header=None)

def test_space_cooling():
    ...
    print("Test complete: space cooling cluster")
