...
from clusters import res_light

test_cluster = res_light.Cluster()
test_dfs = test_cluster.run_cluster()

expected_df = pd.read_csv('expected_res_light.csv', header=None)
...
def test_res_light():
    ...
    print("Test complete: res light cluster")
