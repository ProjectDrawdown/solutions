...
from clusters import space_heating

test_cluster = space_heating.Cluster()
test_dfs = test_cluster.run_cluster()

expected_df = pd.read_csv('expected_space_heating.csv', header=None)

def test_space_heating():
    ...
    print("Test complete: space heating cluster")
