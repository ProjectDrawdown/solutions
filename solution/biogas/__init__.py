...
scenarios = {
  'PDS-1p2050-Plausible (Book Ed.1)': advanced_controls.AdvancedControls(
      ...
      pds_base_adoption=[('World', 55.98669999999999), ('OECD90', 53.60529999999999), ('Eastern Europe', 0.1568), ('Asia (Sans Japan)', 1.6597), ('Middle East and Africa', 0.10709999999999999), ('Latin America', 0.4578), ('China', 0.0), ('India', 0.26949999999999996), ('EU', 41.1474), ('USA', 9.5102)], 
      ...
      ch4_co2_per_funit=553364.0, n2o_co2_per_funit=196895.0, 
