"""Large Biodigesters (Biogas) solution model.
   Excel filename: LargeMethaneDigesters_RRS_ELECGEN_v1.1b_18Jan2020.xlsm
"""
...
VMAs = {
    ...
    'Oil Plant Efficiency': vma.VMA(
        ...
        use_weight=False),
    'Biogas Plant Efficiency Factor': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "Biogas_Plant_Efficiency_Factor.csv"),
        use_weight=False),
