"""Wind Offshore solution model.
   Excel filename: Drawdown-Wind Offshore_RRS.ES_v1.1_13Jan2019_PUBLIC.xlsm
"""
...
scenarios = {
  'PDS-4p2050-Plausible (Book Ed.1)': advanced_controls.AdvancedControls(
      ...
      pds_base_adoption=[('World', 24.89), ('OECD90', 23.97), ('Eastern Europe', 0.0), ('Asia (Sans Japan)', 0.92), ('Middle East and Africa', 0.0), ('Latin America', 0.0), ('China', 0.89), ('India', 0.0), ('EU', 23.82), ('USA', 0.0)], 
      pds_adoption_final_percentage=[('World', 0.0), ('OECD90', 0.0), ('Eastern Europe', 0.0), ('Asia (Sans Japan)', 0.0), ('Middle East and Africa', 0.0), ('Latin America', 0.0), ('China', 0.0), ('India', 0.0), ('EU', 0.0), ('USA', 0.0)], 

      # financial
      pds_2014_cost=3831.443384263814, ref_2014_cost=3831.443384263814, 
      conv_2014_cost=2010.0317085196398, 
      soln_first_cost_efficiency_rate=0.159, 
      conv_first_cost_efficiency_rate=0.02, 
      soln_first_cost_below_conv=True, 
      npv_discount_rate=0.094, 
      soln_lifetime_capacity=68814.66666666667, soln_avg_annual_use=2949.2000000000003, 
      conv_lifetime_capacity=182411.2757676607, conv_avg_annual_use=4946.8401873420025, 

      soln_var_oper_cost_per_funit=0.034335, soln_fuel_cost_per_funit=0.0, 
      soln_fixed_oper_cost_per_iunit=75.14438094666666, 
      ...
      soln_indirect_co2_per_iunit=17338.571428571428, 
  ...
  'PDS-4p2050-Drawdown (Book Ed. 1)': advanced_controls.AdvancedControls(
      # Drawdown Scenario, Based on Greenpeace (2015) Revolution Scenario, Medium Growth
      ...
      soln_ref_adoption_regional_data=False, soln_pds_adoption_regional_data=False, 
      soln_pds_adoption_basis='Existing Adoption Prognostications', 
      soln_pds_adoption_prognostication_source='Based on: Greenpeace 2015 Energy Revolution', 
      soln_pds_adoption_prognostication_trend='3rd Poly', 
      ...
      soln_var_oper_cost_per_funit=0.034335000000000004, soln_fuel_cost_per_funit=0.0, 
      soln_fixed_oper_cost_per_iunit=75.14438094666666, 
      conv_var_oper_cost_per_funit=0.003752690403548987, conv_fuel_cost_per_funit=0.0731, 
      conv_fixed_oper_cost_per_iunit=32.951404311078015, 
  ...
  'PDS-6p2050-Optimum (Book Ed. 1)': advanced_controls.AdvancedControls(
      # Optimum Scenario, Based on Greenpeace (2015) Advanced Revolution, Medium Growth
