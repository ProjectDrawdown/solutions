...
PDS1 = "PDS-1p2050-Plausible (Book Ed.1)"
PDS2 = "PDS-0p2050-Drawdown (Book Ed.1)"
PDS3 = "PDS-0p2050-Optimum (Book Ed.1)"
...
class Scenario(scenario.RRSScenario):
    ...
    def __init__(self, scen=None):
        ...
        # TAM
        self._ref_tam_sources = scenario.load_sources(DATADIR/'energy'/'ref_tam_1_sources.json','*')
        self._pds_tam_sources = scenario.load_sources(DATADIR/'energy'/'pds_tam_1_sources.json','*')
        self.set_tam()
