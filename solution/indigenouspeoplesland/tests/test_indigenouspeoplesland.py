...
solution_name = 'indigenouspeoplesland'
...
def test_indigenouspeoplesland_loader():
...
@pytest.mark.slow
def test_indigenouspeoplesland_results(scenario_skip=None, test_skip=None, test_only=None):
