...
# Originally exported from: SolarPVUtility_RRS_ELECGEN_v1.1b_16Oct21-Postintegration.xlsm
...
PDS1 = "PDS-20p2050-PDS1_June2020"
PDS2 = "PDS-25p2050-PDS2_june2020"
PDS3 = "PDS-25p2050-PDS3_June2020"
...
class Scenario(scenario.RRSScenario):
    ...
    def __init__(self, scen=None):
        ...
        self._ref_tam_sources = scenario.load_sources(rrs.energy_ref_tam(),'*')
        self._pds_tam_sources = scenario.load_sources(rrs.energy_pds_tam(),'*')
        self.set_tam()
        ...
        # other AD parameter overrides
        # groups_include_hundred_percent is a quirks parameter that should apply to energy solutions only
        ...
        pds_initial_year = 2014  # sometimes, but rarely, different than self.base_year
