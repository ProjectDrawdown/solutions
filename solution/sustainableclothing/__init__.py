"""Sustainable Clothing solution model.
   Excel filename: Sustainable Clothing-RRS.IP-0121MRG_2021.xlsm
"""
...
units = {
    ...
    "functional unit": "1 Million Metric Ton Clothing",
    "first cost": "US$B",
    "operating cost": "US$B",
}
