...
VMAs = {
  ...
  'SOLUTION Revenue per Functional Unit': vma.VMA(
      filename=None, use_weight=False),
  'Annual Commuting Days': vma.VMA(
      filename=THISDIR.joinpath("vma_data", "Annual_Commuting_Days.csv"),
      use_weight=False),
  'Average Carpool Occupancy': vma.VMA(
      filename=THISDIR.joinpath("vma_data", "Average_Carpool_Occupancy.csv"),
      use_weight=False),
  'Average One-way North American Commuting Travel Distance': vma.VMA(
      filename=THISDIR.joinpath("vma_data", "Average_One_way_North_American_Commuting_Travel_Distance.csv"),
      use_weight=False),
  'Current Labor Force': vma.VMA(
      filename=THISDIR.joinpath("vma_data", "Current_Labor_Force.csv"),
      use_weight=False),
  'Commuting by Car Mode Share': vma.VMA(
      filename=THISDIR.joinpath("vma_data", "Commuting_by_Car_Mode_Share.csv"),
      use_weight=False),
  'Car Lifetime': vma.VMA(
      filename=THISDIR.joinpath("vma_data", "Car_Lifetime.csv"),
      use_weight=False),
