"""Tropical Forest Restoration solution model.  # bb
   Excel filename: Drawdown-Tropical Forest Restoration_BioS_v1.1_3Jan2019_PUBLIC.xlsm  # bb
"""  # bb
  # bb
import pathlib  # bb
  # bb
...
REGIONS = ['World', 'OECD90', 'Eastern Europe', 'Asia (Sans Japan)', 'Middle East and Africa',  # bb
  ...
  # bb
scenarios = {  # bb
  'PDS-58p2050-Plausible-PDScustomadoption-avg': advanced_controls.AdvancedControls(  # bb
      ...
      # changes in the result in this scenario are due to the addition of more data  # bb
      # points on carbon sequestration and corrections made to the AEZ model, which has  # bb
      # very marginally changed the TLA of this solution. Please note; there are nine  # bb
      # custom adoption scenarios, but this scenario has used only first eight custom  # bb
      # adoption scenarios given in the "Custom PDS adoption sheet".  # bb
  # bb
      # general  # bb
  ...
  # bb
      # sequestration  # bb
      seq_rate_global={'value': 4.37252969045455, 'xls cell formula': 'B175+(B175*C205)'},   # bb
      disturbance_rate=0.0,   # bb
  # bb
    ),  # bb
  'PDS-77p2050-Drawdown-PDScustomadoption-high': advanced_controls.AdvancedControls(  # bb
      # The current adoption of the solution was assumed to be 0. The future adoption  # bb
      # scenarios were built on the commitments given for temperate forest restoration  # bb
      # in the Bonn Challenge and New York Deceleration in addition to the World  # bb
      # Resources Institute's projected estimates for the solution. Several custom  # bb
  ...
  'PDS-84p2050-Optimum-PDScustomadoption-100%in15years': advanced_controls.AdvancedControls(  # bb
      # The current adoption of the solution was assumed to be 0. The future adoption  # bb
      # scenarios were built on the commitments given for temperate forest restoration  # bb
      # in the Bonn Challenge and New York Deceleration in addition to the World  # bb
      # Resources Institute's projected estimates for the solution. Several custom  # bb
      ...
      # restoration of temperate forests in 15 years (by 2030), in 30 years (by 2045),  # bb
      # and in 45 years (by 2060) compare to the situation in 2015. This scenario  # bb
      # presents the result of "Optimistic-Achieve Commitment in 15 years w/ 100%  # bb
      # intact, NYDF/2030" PDS custom adoption scenario. This proposes 100% intact  # bb
      # restoration of degraded tropical forests in 15 years. The changes in the result  # bb
      # in this scenario are due to the addition of more data points on carbon  # bb
      # sequestration and corrections made to the AEZ model, which has very marginally  # bb
      # changed the TLA of this solution. Please note; there are nine custom adoption  # bb
      # scenarios, but this scenario has used only first eight custom adoption scenarios  # bb
      # given in the "Custom PDS adoption sheet".  # bb
  # bb
      # general  # bb
      solution_category=SOLUTION_CATEGORY.LAND,   # bb
      vmas=VMAs,   # bb
  ...
  # bb
      ...
      soln_ref_adoption_regional_data=False, soln_pds_adoption_regional_data=False,   # bb
      soln_pds_adoption_basis='Fully Customized PDS',   # bb
      soln_pds_adoption_custom_name='Optimistic-Achieve Commitment in 15 years w/ 100% intact, NYDF/2030 (Charlotte Wheeler, 2016)',   # bb
      pds_adoption_final_percentage=[('World', 0.0), ('OECD90', 0.0), ('Eastern Europe', 0.0), ('Asia (Sans Japan)', 0.0), ('Middle East and Africa', 0.0), ('Latin America', 0.0), ('China', 0.0), ('India', 0.0), ('EU', 0.0), ('USA', 0.0)],   # bb
  # bb
      # financial  # bb
      pds_2014_cost=0.0, ref_2014_cost=0.0,   # bb
  ...
  'PDS-58p2050-Plausible-PDScustom-avg-Bookedition1': advanced_controls.AdvancedControls(  # bb
      ...
      # data points are stored as separate scenarios. The current adoption of the  # bb
      # solution was assumed to be 0. The future adoption scenarios were built on the  # bb
      # commitments given for temperate forest restoration in the Bonn Challenge and New  # bb
      # York Deceleration in addition to the World Resources Institute's projected  # bb
      # estimates for the solution. Several custom adoption scenarios were built to  # bb
      # project either the intact or wide scale restoration of temperate forests in 15  # bb
      # years (by 2030), in 30 years (by 2045), and in 45 years (by 2060) compare to the  # bb
      # situation in 2015. This scenario derives the result from the "average of all"  # bb
      # PDS custom adoption scenarios. Please note; there are nine custom adoption  # bb
      # scenarios, but this scenario has used only first seven custom adoption scenarios  # bb
      # given in the "Custom PDS adoption sheet".  # bb
  # bb
      # general  # bb
      solution_category=SOLUTION_CATEGORY.LAND,   # bb
  ...
  # bb
      # sequestration  # bb
      seq_rate_global=4.150868085,   # bb
      disturbance_rate=0.0,   # bb
  # bb
    ),  # bb
  'PDS-79p2050-Drawdown-PDScustom-high-Bookedition1': advanced_controls.AdvancedControls(  # bb
      # This scenario presents the plausible scenario results of the Book edition 1.  # bb
      # Thus, it has the same inputs as that of Book edition 1. The results based on new  # bb
      # data points are stored as separate scenarios. The current adoption of the  # bb
      # solution was assumed to be 0. The future adoption scenarios were built on the  # bb
      ...
      # project either the intact or wide scale restoration of temperate forests in 15  # bb
      # years (by 2030), in 30 years (by 2045), and in 45 years (by 2060) compare to the  # bb
      # situation in 2015. This scenario derives the result from the "high of all" PDS  # bb
      # custom adoption scenarios. Please note; there are nine custom adoption  # bb
      # scenarios, but this scenario has used only first seven custom adoption scenarios  # bb
      # given in the "Custom PDS adoption sheet".  # bb
  # bb
      # general  # bb
  ...
  'PDS-84p2050-Optimum-PDScustom-100%intact15years-Bookedition1': advanced_controls.AdvancedControls(  # bb
      # This scenario presents the plausible scenario results of the Book edition 1.  # bb
      # Thus, it has the same inputs as that of Book edition 1. The results based on new  # bb
      # data points are stored as separate scenarios. The current adoption of the  # bb
      # solution was assumed to be 0. The future adoption scenarios were built on the  # bb
      ...
      # project either the intact or wide scale restoration of temperate forests in 15  # bb
      # years (by 2030), in 30 years (by 2045), and in 45 years (by 2060) compare to the  # bb
      # situation in 2015. This scenario presents the result of "Optimistic-Achieve  # bb
      # Commitment in 15 years w/ 100% intact, NYDF/2030" PDS custom adoption scenario.  # bb
      # This proposes 100% intact restoration of degraded tropical forests in 15 years.  # bb
  ...
  # bb
class TropicalForests:  # bb
  name = 'Tropical Forest Restoration'  # bb
  units = {  # bb
  ...
  def __init__(self, scenario=None):  # bb
    if scenario is None:  # bb
      scenario = 'PDS-58p2050-Plausible-PDScustomadoption-avg'  # bb
  ...
  # bb
    ...
    ca_pds_data_sources = [  # bb
      {'name': 'Optimistic-Achieve Commitment in 15 years w/ 100% intact, NYDF/2030 (Charlotte Wheeler, 2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_OptimisticAchieve_Commitment_in_15_years_w_100_intact_NYDF2030_a0989ced.csv')},  # bb
      {'name': 'Optimistic-Achieve Commitment in 15 years w/ 100% intact, WRI/2030 (Charlotte Wheeler, 2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_OptimisticAchieve_Commitment_in_15_years_w_100_intact_WRI2030_C3779a48e.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 15 years w/ 32.8% intact, WRI/2030 (Charlotte Wheeler,2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_15_years_w_32_8_intact_WRI2036995f18a.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 15 years w/ 32.8% intact with continued growth post-2030, WRI/2030 and beyond (Charlotte Wheeler,2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_15_years_w_32_8_intact_with_c1bb8b9cc.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 30 years w/ 100% intact, WRI/2045 (Charlotte Wheeler,2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_30_years_w_100_intact_WRI20451dd0e069.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 30 years w/ 32.8% intact, WRI/2045 (Charlotte Wheeler,2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_30_years_w_32_8_intact_WRI2042a54d685.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 30 years w/ 32.8% intact with continued growth, WRI/2045 (Charlotte Wheeler,2016)', 'include': True,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_30_years_w_32_8_intact_with_c3be462ea.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 45 years w/ 100% intact, WRI/2060 (Charlotte Wheeler,2016)', 'include': False,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_45_years_w_100_intact_WRI20601dd0e069.csv')},  # bb
      {'name': 'Conservative-Achieve Commitment in 45 years w/ 32.8% intact, WRI/2060 (Charlotte Wheeler,2016)', 'include': False,  # bb
          'filename': THISDIR.joinpath('ca_pds_data', 'custom_pds_ad_ConservativeAchieve_Commitment_in_45_years_w_32_8_intact_WRI2066995f18a.csv')},  # bb
    ]  # bb
