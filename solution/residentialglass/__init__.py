"""High-Performance Glass (Residential) solution model.
   Excel filename: Glass_RRS_Model_Residential-Nov19.xlsm
"""
...
VMAs = {
    ...
    'Discount Rate - Households': vma.VMA(
        ...
        use_weight=False),
    'Residential Window to Floor Ratio': vma.VMA(
        filename=THISDIR.joinpath("vma_data", "Residential_Window_to_Floor_Ratio.csv"),
        use_weight=True),
}
...
PDS1 = "PDS1-73p2050-2.75% Retrofit Rate (Integrated)"
