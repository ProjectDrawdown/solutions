...
solution_name = 'irrigationefficiency'
...
def test_irrigationefficiency_loader():
...
@pytest.mark.slow
def test_irrigationefficiency_results(scenario_skip=None, test_skip=None, test_only=None):
