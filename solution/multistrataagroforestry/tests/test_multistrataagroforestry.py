...
solution_name = 'multistrataagroforestry'
...
def test_multistrataagroforestry_loader():
...
@pytest.mark.slow
def test_multistrataagroforestry_results(scenario_skip=None, test_skip=None, test_only=None):
