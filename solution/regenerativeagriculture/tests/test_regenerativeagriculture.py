...
solution_name = 'regenerativeagriculture'
...
def test_regenerativeagriculture_loader():
...
@pytest.mark.slow
def test_regenerativeagriculture_results(scenario_skip=None, test_skip=None, test_only=None):
