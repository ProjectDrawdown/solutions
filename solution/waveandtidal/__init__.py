"""Wave and Tidal solution model.
   Excel filename: Drawdown-Wave and Tidal_RRS.ES_v1.1_13Jan2019_PUBLIC.xlsm
"""
...
scenarios = {
  'PDS-4p2050-Optimum (Book Ed. 1)': advanced_controls.AdvancedControls(
      # Optimum Scenario, Based on Greenpeace Advanced Adoption, medium Growth. Adoption
      # slightly revised from book version. Inputs as in Plausible
      ...
      pds_adoption_use_ref_years=[2015, 2016, 2017, 2018], 
      source_until_2014='ALL SOURCES', 
      ref_source_post_2014='Baseline Cases', 
      pds_source_post_2014='Drawdown TAM: Drawdown TAM - Post Integration - Optimum Scenario', 
      pds_base_adoption=[('World', 0.954), ('OECD90', 0.483), ('Eastern Europe', 0.002), ('Asia (Sans Japan)', 0.453), ('Middle East and Africa', 0.0), ('Latin America', 0.016), ('China', 0.007), ('India', 0.0), ('EU', 0.483), ('USA', 0.0)], 
      pds_adoption_final_percentage=[('World', 0.0), ('OECD90', 0.0), ('Eastern Europe', 0.0), ('Asia (Sans Japan)', 0.0), ('Middle East and Africa', 0.0), ('Latin America', 0.0), ('China', 0.0), ('India', 0.0), ('EU', 0.0), ('USA', 0.0)], 

      # financial
      pds_2014_cost=8040.426104166666, ref_2014_cost=8040.426104166666, 
      conv_2014_cost=2010.0317085196398, 
      soln_first_cost_efficiency_rate=0.155, 
      conv_first_cost_efficiency_rate=0.02, 
      soln_first_cost_below_conv=True, 
      npv_discount_rate=0.094, 
      soln_lifetime_capacity=76552.08538461538, soln_avg_annual_use=2621.770666666667, 
      conv_lifetime_capacity=182411.2757676607, conv_avg_annual_use=4946.8401873420025, 

      soln_var_oper_cost_per_funit=0.11404119058823531, soln_fuel_cost_per_funit=0.0, 
      soln_fixed_oper_cost_per_iunit=72.5, 
      ...
      soln_indirect_co2_per_iunit=19385.714285714286, 
  ...
  'PDS-3p2050-Plausible (Book Ed. 1)': advanced_controls.AdvancedControls(
      # Plausible Scenario, Based on Ambitious scenarios projections, High Growth
  ...
  'PDS-4p2050-Drawdown (Book Ed.1)': advanced_controls.AdvancedControls(
...
class WaveAndTidal:
  ...
  def __init__(self, scenario=None):
    if scenario is None:
      scenario = 'PDS-4p2050-Optimum (Book Ed. 1)'
    ...
    ht_ref_adoption_initial = pd.Series(
      [0.954, 0.483, 0.002, 0.453, 0.0,
       0.016, 0.007, 0.0, 0.483, 0.0],
       index=REGIONS)
