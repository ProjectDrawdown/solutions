"""Landfill Methane Capture solution model.
   Excel filename: LandfillMethane_RRS_ELECGEN_v1.1c_24Oct18.xlsm
"""
...
scenarios = {
  ...
  'PDS-0p2050-Drawdown (Book Ed.1)_Emissions1': advanced_controls.AdvancedControls(
      report_start_year = 2020, report_end_year = 2050, 
      ...
      soln_ref_adoption_regional_data = False, soln_pds_adoption_regional_data = False, 
      soln_pds_adoption_basis = 'Existing Adoption Prognostications', 
      soln_pds_adoption_prognostication_source = 'AMPERE MESSAGE 450', 
      soln_pds_adoption_prognostication_trend = '3rd Poly', 
      soln_pds_adoption_prognostication_growth = 'Medium', 
      source_until_2014 = 'ALL SOURCES', 
      ref_source_post_2014 = 'Baseline Cases', 
  ...
  'PDS-0p2050-Drawdown (Book Ed.1)_emissions 2': advanced_controls.AdvancedControls(
      report_start_year = 2020, report_end_year = 2050, 
      ...
      soln_indirect_co2_per_iunit = 0.0, 
      conv_indirect_co2_per_unit = 0.0, conv_indirect_co2_is_iunits = False, 
      ch4_co2_per_twh = 553364.0, n2o_co2_per_twh = 0.0, 
  ...
  'PDS-0p2050-Optimum Book Ed.1) emissions 2': advanced_controls.AdvancedControls(
      report_start_year = 2020, report_end_year = 2050, 
      ...
      soln_ref_adoption_regional_data = False, soln_pds_adoption_regional_data = False, 
      soln_pds_adoption_basis = 'Existing Adoption Prognostications', 
      soln_pds_adoption_prognostication_source = 'Greenpeace 2015 Advanced Energy Revolution Scenario', 
      soln_pds_adoption_prognostication_trend = '3rd Poly', 
      soln_pds_adoption_prognostication_growth = 'Medium', 
      source_until_2014 = 'ALL SOURCES', 
      ref_source_post_2014 = 'Baseline Cases', 
  ...
  'PDS-0p2050-Optimum (Book Ed.1) emissions 1': advanced_controls.AdvancedControls(
      report_start_year = 2020, report_end_year = 2050, 
...
class LandfillMethane:
  ...
  def __init__(self, scenario=None):
    ...
    ad_data_sources = {
      'Baseline Cases': {
        'IEA ETP 2016 6DS': str(thisdir.joinpath('ad_based_on_IEA_ETP_2016_6DS.csv')),
        'AMPERE GEM E3 REFpol': str(thisdir.joinpath('ad_based_on_AMPERE_2014_GEM_E3_Reference.csv')),
        'AMPERE IMAGE REFpol': str(thisdir.joinpath('ad_based_on_AMPERE_2014_IMAGE_TIMER_Reference.csv')),
        'AMPERE MESSAGE REFpol': str(thisdir.joinpath('ad_based_on_AMPERE_2014_MESSAGE_MACRO_Reference.csv')),
      },
      'Conservative Cases': {
        'IEA ETP 2016 4DS': str(thisdir.joinpath('ad_based_on_IEA_ETP_2016_4DS.csv')),
        'Greenpeace 2015 Reference Scenario': str(thisdir.joinpath('ad_based_on_Greenpeace_2015_Reference.csv')),
        'AMPERE GEM E3 550': str(thisdir.joinpath('ad_based_on_AMPERE_2014_GEM_E3_550.csv')),
        'AMPERE IMAGE 550': str(thisdir.joinpath('ad_based_on_AMPERE_2014_IMAGE_TIMER_550.csv')),
        'AMPERE MESSAGE 550': str(thisdir.joinpath('ad_based_on_AMPERE_2014_MESSAGE_MACRO_550.csv')),
      },
      'Ambitious Cases': {
        'IEA ETP 2016 2DS': str(thisdir.joinpath('ad_based_on_IEA_ETP_2016_2DS.csv')),
        'Greenpeace 2015 Energy Revolution Scenario': str(thisdir.joinpath('ad_based_on_Greenpeace_2015_Energy_Revolution.csv')),
        'AMPERE GEM E3 450': str(thisdir.joinpath('ad_based_on_AMPERE_2014_GEM_E3_450.csv')),
        'AMPERE IMAGE 450': str(thisdir.joinpath('ad_based_on_AMPERE_2014_IMAGE_TIMER_450.csv')),
        'AMPERE MESSAGE 450': str(thisdir.joinpath('ad_based_on_AMPERE_2014_MESSAGE_MACRO_450.csv')),
        '[Source 6 - Ambitious]': str(thisdir.joinpath('ad_source_6_ambitious.csv')),
      },
      '100% Case': {
        'Greenpeace 2015 Advanced Energy Revolution Scenario': str(thisdir.joinpath('ad_based_on_Greenpeace_2015_Advanced_Revolution.csv')),
      },
    }
    ...
    ht_ref_datapoints = pd.DataFrame([
      [2014, 23.99, 22.97, 0.07, 0.71,
       0.05, np.nan, np.nan, 0.12,
       17.63, 4.07],
      [2050, 58.022180681802915, 29.82926240605038, 0.11016910330548059, 2.028267732619746,
       0.0, 0.0, 0.0, 0.6258517817139966,
       23.229467980388975, 5.090424759054919]],
