    ...
    def __init__(self, scenario=None):
        ...
        ad_data_sources = {
            'Baseline Cases': {
                ...
                'Based on: Grantham Institute and Carbon Tracker (2017), Nationally Determined Contributions (NDC) Scenario, PVEV medium scenario': THISDIR.joinpath('ad', 'ad_based_on_Grantham_Institute_and_Carbon_Tracker_2017_Nationally_Determined_Contributions__30307e8e.csv'),
            ...
            'Ambitious Cases': {
                ...
                'Based on: Grantham Institute and Carbon Tracker (2017), Strong PVEV medium scenario': THISDIR.joinpath('ad', 'ad_based_on_Grantham_Institute_and_Carbon_Tracker_2017_Strong_PVEV_medium_scenario.csv'),
            },
            '100% RES2050 Case': {
                'Based on: LUT/EWG (2019) -100% RES': THISDIR.joinpath('ad', 'ad_based_on_LUTEWG_2019_100_RES.csv'),
            },
        }
