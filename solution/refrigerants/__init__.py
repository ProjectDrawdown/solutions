...
# Originally exported from: RRS_RefrigerantManagementModel_June2020Integration_PopsAdj_06Oct2021.xlsm
...
# Note: this is not a typo: refrigerants has only a single scenario for all PDS.
PDS1 = "PDS1-3-100p2050-Oct2020-popadjus"
PDS2 = "PDS1-3-100p2050-Oct2020-popadjus"
PDS3 = "PDS1-3-100p2050-Oct2020-popadjus"
...
class Scenario(scenario.RRSScenario):
    ...
    def __init__(self, scen=None):
        ...
        tam_overrides = [('growth','World','High'),('growth','PDS World','High')]
