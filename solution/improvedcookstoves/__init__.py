...
class ImprovedCookStoves:
  ...
  def __init__(self, scenario=None):
    ...
    tam_ref_data_sources = {
      'Baseline Cases': {
          'Calculated  from 2 sources - World Bank (2015) The State of the global Clean and Improved Cooking Sector, https://openknowledge.worldbank.org/bitstream/handle/10986/21878/96499.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_World_Bank_2015_The_State_of_the_globa.csv'),
          'Calculated  from 2 sources - REN21 (2015) Renewables 2015 - Global Status Report, http://www.ren21.net/wp-content/uploads/2015/07/REN12-GSR2015_Onlinebook_low1.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_REN21_2015_Renewables_2015_Global_Stat.csv'),
          'Drawdown Summation: Regional Sum': thisdir.joinpath('tam_Drawdown_Summation_Regional_Sum.csv'),
      },
      'Conservative Cases': {
          'Based on IEA (2013) World Energy Outlook': thisdir.joinpath('tam_based_on_IEA_2013_World_Energy_Outlook.csv'),
      },
      'Region: Asia (Sans Japan)': {
        'Baseline Cases': {
          'Calculated  from summing India and China from 2 sources - World Bank (2015) The State of the global Clean and Improved Cooking Sector, https://openknowledge.worldbank.org/bitstream/handle/10986/21878/96499.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_summing_India_and_China_from_2_sources_World_Ban.csv'),
          'Calculated  from 2 sources - World Bank (2015) The State of the global Clean and Improved Cooking Sector, https://openknowledge.worldbank.org/bitstream/handle/10986/21878/96499.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_World_Bank_2015_The_State_of_the_globa.csv'),
          'Calculated  from 2 sources - REN21 (2015) Renewables 2015 - Global Status Report, http://www.ren21.net/wp-content/uploads/2015/07/REN12-GSR2015_Onlinebook_low1.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_REN21_2015_Renewables_2015_Global_Stat.csv'),
        },
        'Conservative Cases': {
      ...
      'Region: Middle East and Africa': {
        'Baseline Cases': {
          'Based on Ibitoye, F. I. (2013). The millennium development goals and household energy requirements in Nigeria. SpringerPlus, 2(1), 529.': thisdir.joinpath('tam_based_on_Ibitoye_F__I__2013__The_millennium_development_goals_an.csv'),
          'Calculated  from 2 sources - World Bank (2015) The State of the global Clean and Improved Cooking Sector, https://openknowledge.worldbank.org/bitstream/handle/10986/21878/96499.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_World_Bank_2015_The_State_of_the_globa.csv'),
          'Calculated  from 2 sources - REN21 (2015) Renewables 2015 - Global Status Report, http://www.ren21.net/wp-content/uploads/2015/07/REN12-GSR2015_Onlinebook_low1.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_REN21_2015_Renewables_2015_Global_Stat.csv'),
        },
        'Conservative Cases': {
      ...
      'Region: China': {
        ...
        'Conservative Cases': {
          'Based on Yuan, Y., & Zhao, I. (2013). Energy in Rural Areas of Northern China. Journal of Applied Sciences, 13(9), 1449-1454.': thisdir.joinpath('tam_based_on_Yuan_Y__Zhao_I__2013__Energy_in_Rural_Areas_of_Northern.csv'),
        },
        'Ambitious Cases': {
          'Based on IEA (2013) World Energy Outlook': thisdir.joinpath('tam_based_on_IEA_2013_World_Energy_Outlook.csv'),
          'Based on Mainali, B., Pachauri, S., & Nagai, Y. (2012). Analyzing cooking fuel and stove choices in China till 2030. Journal of Renewable and Sustainable Energy, 4(3), 031805.': thisdir.joinpath('tam_based_on_Mainali_B__Pachauri_S__Nagai_Y__2012__Analyzing_cooking.csv'),
        },
      },
      'Region: India': {
        'Baseline Cases': {
          'Based on Nakagami, H., Murakoshi, C., & Iwafune, Y. (2008). International comparison of household energy consumption and its indicator. Proceedings of the 2008 ACEEE Summer Study on Energy Efficiency in Buildings, 214-224.': thisdir.joinpath('tam_based_on_Nakagami_H__Murakoshi_C__Iwafune_Y__2008__International.csv'),
          'Calculated  from 2 sources - World Bank (2015) The State of the global Clean and Improved Cooking Sector, https://openknowledge.worldbank.org/bitstream/handle/10986/21878/96499.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_World_Bank_2015_The_State_of_the_globa.csv'),
          'Calculated  from 2 sources - REN21 (2015) Renewables 2015 - Global Status Report, http://www.ren21.net/wp-content/uploads/2015/07/REN12-GSR2015_Onlinebook_low1.pdf AND Daioglou, V., Van Ruijven, B. J., & Van Vuuren, D. P. (2012). Model projections for household energy use in developing countries. Energy, 37(1), 601-615.': thisdir.joinpath('tam_Calculated_from_2_sources_REN21_2015_Renewables_2015_Global_Stat.csv'),
        },
        'Conservative Cases': {
        ...
        'Maximum Cases': {
          'Based on Venkataraman, C., Sagar, A. D., Habib, G., Lam, N., & Smith, K. R. (2010). The Indian national initiative for advanced biomass cookstoves: the benefits of clean combustion. Energy for Sustainable Development, 14(2), 63-72.': thisdir.joinpath('tam_based_on_Venkataraman_C__Sagar_A__D__Habib_G__Lam_N__Smith_K__R_.csv'),
        },
      },
    }
    ...
    ad_data_sources = {
      'Baseline Cases': {
          'Global alliance For Clean cookstoves -  Interpolated': thisdir.joinpath('ad_Global_alliance_For_Clean_cookstoves_Interpolated.csv'),
          'International Energy Agency  -  Interpolated': thisdir.joinpath('ad_International_Energy_Agency_Interpolated.csv'),
          'The World Bank': thisdir.joinpath('ad_The_World_Bank.csv'),
      },
    }
