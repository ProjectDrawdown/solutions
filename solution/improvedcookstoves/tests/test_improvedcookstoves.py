...
solution_name = 'improvedcookstoves'
...
def test_improvedcookstoves_loader():
...
@pytest.mark.slow
def test_improvedcookstoves_results(scenario_skip=None, test_skip=None, test_only=None):
