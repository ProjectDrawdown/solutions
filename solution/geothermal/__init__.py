"""Geothermal solution model.
   Excel filename: Geothermal_RRS_ELECGEN_v1.1b_18Jan2020.xlsm
"""
    ...
    def __init__(self, scenario=None):
        ...
        ad_data_sources = {
            ...
            'Ambitious Cases': {
                ...
                'Based on Grantham (2017)-NDC_PVEV_Med.': THISDIR.joinpath('ad', 'ad_based_on_Grantham_2017NDC_PVEV_Med_.csv'),
            },
            '100% RES2050 Case': {
