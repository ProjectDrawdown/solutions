...
solution_name = 'mangroverestoration'
...
def test_mangroverestoration_loader():
...
@pytest.mark.slow
def test_mangroverestoration_results(scenario_skip=None, test_skip=None, test_only=None):
