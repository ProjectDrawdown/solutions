...
solution_name = 'grasslandprotection'
...
def test_grasslandprotection_loader():
...
@pytest.mark.slow
def test_grasslandprotection_results(scenario_skip=None, test_skip=None, test_only=None):
