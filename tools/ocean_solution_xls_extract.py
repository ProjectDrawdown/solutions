...
def main():
    ...
    soln_name = 'Macroalgae Restoration'

    path_to_here = pathlib.Path(__file__).parent.parent
    config_file = os.path.join(path_to_here,'solution/macroalgaerestoration/ocean_solution_xls_extract_config.yaml')
    ...
    import_spec_path = os.path.join(path_to_here,'solution/macroalgaerestoration/ocean_solution_xls_extract_spec.yaml')
