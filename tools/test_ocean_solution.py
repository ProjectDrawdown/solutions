...
class TestOceanSolution():
    ...
    def test_adoption_unit_increase_pds_vs_ref_final_year(self, solution, scenario_name, expected_results):
    ...
    def test_adoption_unit_increase_pds_final_year(self, solution, scenario_name, expected_results):
        result = solution.get_adoption_unit_increase_pds_final_year()
        expected_result = expected_results['Global Units of Adoption in Final Year']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
    ...
    def test_global_percent_adoption_base_year(self, solution, scenario_name, expected_results):
        result = solution.get_global_percent_adoption_base_year()
        expected_result = expected_results['Global Percent Adoption in Base Year']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
    ...
    def test_percent_adoption_start_year(self, solution, scenario_name, expected_results):
        result = solution.get_percent_adoption_start_year()
        expected_result = expected_results['Global Percent Adoption in Start Year']
        try:
    ...
    def test_get_percent_adoption_end_year(self, solution, scenario_name, expected_results):
        result = solution.get_percent_adoption_end_year()
        expected_result = expected_results['Global Percent Adoption in Final Year']
        try:
    ...
    def test_emissions_reduction_series(self, solution, scenario_name, expected_results):
    ...
    def test_total_emissions_reduction(self, solution, scenario_name, expected_results):
    ...
    def test_max_annual_emissions_reduction(self, solution, scenario_name, expected_results):
    ...
    def test_emissions_reduction_final_year(self, solution, scenario_name, expected_results):
    ...
    def test_carbon_sequestration_series(self, solution, scenario_name, expected_results):
    ...
    def test_total_co2_sequestered(self, solution, scenario_name, expected_results):
        result = solution.get_total_co2_sequestered()
        expected_result = expected_results['Total Additional CO2-eq Sequestered']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
    ...
    def test_max_annual_co2_sequestered(self, solution, scenario_name, expected_results):
        result = solution.get_max_annual_co2_sequestered()
        expected_result = expected_results['Max Annual CO2 Sequestered']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
    ...
    def test_co2_sequestered_final_year(self, solution, scenario_name, expected_results):
        result = solution.get_co2_sequestered_final_year()
        expected_result = expected_results['CO2 Sequestered in Final Year']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
...
class TestOceanSolutionFinancialResults():
    ...
    def test_get_marginal_first_cost(self, solution, scenario_name, expected_results):
    ...
    def test_get_operating_cost(self, solution, scenario_name, expected_results):
    ...
    def test_get_lifetime_operating_savings(self, solution, scenario_name, expected_results):
    ...
    def test_get_lifetime_cashflow_npv_all(self, solution, scenario_name, expected_results):
    ...
    def test_get_net_profit_margin(self, solution, scenario_name, expected_results):
        result = solution.get_net_profit_margin()
        expected_result = expected_results['Net Profit Margin Across Reporting Period']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
    ...
    def test_get_lifetime_profit_margin(self, solution, scenario_name, expected_results):
        result = solution.get_lifetime_profit_margin()
        expected_result = expected_results['Lifetime Profit Margin']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
...
class TestOceanSolutionProtectionResults():
    ...
    def test_reduced_area_degradation(self, solution, scenario_name, expected_results):
        ...
        expected_result = expected_results['Reduced Area Degradation Across Reporting Period']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
    ...
    def test_co2_under_protection_final_year(self, solution, scenario_name, expected_results):
        result = solution.get_co2_under_protection_final_year()
        result = max(result, 0.0)
        expected_result = expected_results['Total CO2 Under Protection by End Year']
        try:
            assert result == pytest.approx(expected_result)
        except AssertionError as ae:
            msg = f'Failed on scenario {scenario_name}'
