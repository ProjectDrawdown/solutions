...
def test_vega_json_schema():
  ...
  instance = ui.vega.solution_treemap(solutions=solutions, width=400, height=800)
  # jsonschema.validate will raise an exception on failure
  jsonschema.validate(instance=instance, schema=schema)
  instance = ui.vega.solution_donut_chart(solutions=solutions, width=400, height=400)
  jsonschema.validate(instance=instance, schema=schema)
